...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label_2.setGeometry(QtCore.QRect(70, 50, 161, 121))
        font = QtGui.QFont()
        font.setFamily("Calibri")
        font.setPointSize(14)
        ...
        self.pushButton.setGeometry(QtCore.QRect(60, 20, 201, 51))
        self.pushButton.setStyleSheet("background-color: rgb(241, 162, 183);")
        ...
        self.pushButton.clicked.connect(MainWindow.voiceBtnClick)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton.setText(_translate("MainWindow", "开始说话"))
